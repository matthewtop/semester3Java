...
public class Errors {
    public static void zlyWyborError(){System.err.println("Nieprawidlowy wybor.");}
    public static void zlyPeselError(){System.err.println("Zly pesel");}
    public static void pracownikNieIstniejeError(){System.err.println("Pracownik nie istnieje.");}
    ...
    public static void brakBlikuError(){System.err.println("Brak pliku.");}
    public static void cosPoszloNieTakError(){System.err.println("Cos poszlo nie tak.");}
